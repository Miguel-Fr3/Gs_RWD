...
export default function Home() {
  return (
    ...
    <div className='beneficios'>
      ...
      <div>
        <Image src="/img4.png" alt="Imagem de Redução de Fila de Espera" width={200} height={140} priority={true} className='img'/>
      ...
      <div>
        <Image src="/img2.png" alt="Imagem de Acessibilidade Digital" width={200} height={140} priority={true} className='img'/>
      ...
      <div>
        <Image src="/img3.png" alt="Imagem de Redução de erros" width={200} height={140} priority={true} className='img'/>
